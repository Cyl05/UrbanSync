        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="font-medium text-gray-900">{issue.latitude.toFixed(6)}</p>
            </div>
            <div>
              <span className="text-gray-500">Longitude:</span>
              <p className="font-medium text-gray-900">{issue.longitude.toFixed(6)}</p>
            </div>
          </div>
          <div className="aspect-video bg-gray-100 rounded-lg overflow-hidden">
            <iframe
              ...
              height="100%"
              frameBorder="0"
              src={`https://www.openstreetmap.org/export/embed.html?bbox=${issue.longitude - 0.005},${issue.latitude - 0.005},${issue.longitude + 0.005},${issue.latitude + 0.005}&layer=mapnik&marker=${issue.latitude},${issue.longitude}`}
            />
          </div>
          <a

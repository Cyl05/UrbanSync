import { FaClock, FaUser, FaBuilding, FaExclamationCircle } from "react-icons/fa";
        ...
        <div className="space-y-4">
          ...
          {issue.userByCreatedBy && (
            <div>
              ...
              <p className="text-gray-900 font-medium">{issue.userByCreatedBy.name}</p>
              <p className="text-gray-600 text-sm">{issue.userByCreatedBy.email}</p>
            </div>
          )}
          ...
          {issue.department && (
            <div>
              ...
              {issue.department.description && (
                <p className="text-gray-600 text-sm">{issue.department.description}</p>
              )}
            </div>
          )}
          ...
          {issue.user && (
            <div>
              ...
              <p className="text-gray-900 font-medium">{issue.user.name}</p>
              <p className="text-gray-600 text-sm">{issue.user.email}</p>
            </div>
          )}
          ...
          <div>
            ...
            <p className="text-gray-900 text-sm">{formatDate(issue.created_at)}</p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-900 text-sm">{formatDate(issue.updated_at)}</p>
          </div>
        </div>
      </div>
